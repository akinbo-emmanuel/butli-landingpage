...
const About = () => {
  return (
    <section id="about" className="bg-[#428c9d] py-20 md:py-32 flex items-center">
  <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center animate-fadeIn animate-slideUp">
    <div>
      <h2 className="text-3xl font-bold mb-4">Our Vision</h2>
      <p>
        To raise and build a society of leaders who solely rely on Bible-based
        leadership and management principles in transforming their families,
        communities, organization and nations.
      </p>
      <h2 className="text-3xl font-bold mb-4 mt-8">Our Mission</h2>
      <p>To build the leadership capacity of every Believer.</p>
      <h2 className="text-3xl font-bold mb-4 mt-8">Our Motto</h2>
      <p>Legacy and Impact...</p>
      <h2 className="text-3xl font-bold mb-4 mt-8">Our Core-Values</h2>
      <p>
    ...
    <div className="grid grid-cols-2 gap-4">
      <Image
        ...
        width={300}
        height={200}
        className="rounded-lg animate-fadeIn animate-slideUp"
      />
      <Image
